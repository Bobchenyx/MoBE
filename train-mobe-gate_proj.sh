...
CUDA_VISIBLE_DEVICES=0 python -u train.py --index_path $MODEL_DIR/$MODEL_NAME/model.safetensors.index.json \
      ...
      --activation 'silu' 2>&1 | tee logs/train_mobe_$MODEL_NAME-gate_proj.log
